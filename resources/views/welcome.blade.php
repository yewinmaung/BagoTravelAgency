...
<head>
    ...
    <!-- site metas -->
    <title>Bago Tourism Industry</title>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                    <div class="full">
                        <div class="center-desk">
                            <div class="logo"> <a href="{{route("home")}}"><img src="{{asset("data/images/1x/bago-logo1.png")}}" alt="#"></a> </div>
                        </div>
                    </div>
                </div>
...
<section class="container-fluid position-relative">
    <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
        <!-- <ol class="carousel-indicators">
            ...
            <li data-target="#carouselExampleAutoplaying" data-slide-to="2"></li>
        </ol> -->
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img  class="d-block w-100" src="{{asset("data/images/interestplace/a8.PNG")}}" alt="First slide">
                <div class="carousel-caption d-none d-md-block">
                   <h1 class="fs-1" style="font-weight: bolder; color:aliceblue">Welcome to Bago</h1>
                   <p>Bago is a fascinating place with rich history and beautiful landmarks.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{asset("data/images/pagodas/Shwe Maw Taw2.jpg")}}" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
                   <h1 class="fs-1" style="font-weight: bolder; color:aliceblue">Shwe Maw Taw</h1>
                   <p>Shwe Maw Daw Pagoda, also known as the "Great Golden God," is one of the most iconic and revered pagodas in Myanmar. </p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 h-100" src="{{asset("data/images/palace/Kanbawza-Thardi-Palace.jpg")}}" alt="Third slide">
                <div class="carousel-caption d-none d-md-block">
                   <h1 class="fs-1" style="font-weight: bolder; color:aliceblue">Kanbawzathardo Golden Palace</h1>
                   <p>Kanbawzathadi Palace, located in Bago, is a reconstruction of the original palace of King Bayinnaung, who ruled the Toungoo Dynasty in the 16th century.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="titlepage">
                    ...
                    <span class="text-lg-end">Bago is a region in Myanmar located close to Yangon region. Bago City, formerly known as Hanthawaddy is the capital of Bago region. it is located 80 kilometres north-east of Yangon. It is a popular trip destination for tourists visiting Yangon due to proximity. Bago offers a perfect milieu of nature and culture to tourists. It is renowned for handicrafts as well as a vast wildlife sanctuary. It has a population of 220,000.  Being an ancient capital of Mon Kingdom in 15th century, you can enjoy the Bago sightseeing including ancient Buddha Images. Most sightseeing is Shwethalyaung Reclining Buddha (55 metres long), Shwemawdaw Pagoda, and 28 meter high huge Buddha Image of Kyaikpun Pagoda with its four huge Buddha Images facing the cardinal points and the one interest place is Kanbawzathardi Palace.</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="titlepage">
                    ...
                    <span>"Choose from a variety of packages tailored to your preferences and needs."</span>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="traveling-box card p-2">
                    <i><img src="{{asset("images/$p->img")}}" alt="icon" class="img-fluid w-100 h-80 rounded-top"/></i>
                    <h3>{{$p->name}}</h3>
...
<div class="Tours">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>Short Trip In Bago</h2>
                    <span>
                        Moe Yun Gyi Wetland Resort is a unique and serene destination located about 113 kilometers from Bago City, Myanmar. It’s a popular spot for nature lovers and bird watchers, offering a peaceful retreat in a natural wetland environment.<br/>
                        Shwe Pyi Resort is a well-known retreat located near Bago, Myanmar, offering a blend of natural beauty and modern amenities. 
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/moe-yun-gyi-resort-19.jfif")}}" alt="#" />
                            <h3>Location and Accessibility</h3>
                            <span>
                            Address : 70 Miles, Ygn/Mdl Old Express PyinBonGyi, Bago City<br/>
                            Contact : 05270113<br/>
                            Approximately 2-3 hours by car from Bago City. Situated within the Moe Yun Gyi Wetland Wildlife Sanctuary, which is one of Myanmar's most significant wetland ecosystems.

                            </span>
                        </div>
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/moe-yun-gyi-resort-20.jfif")}}" alt="#" />
                            <h3>Activities</h3>
                        ...
                        <div class="item">
                            <img class="img-fluid w-100 h-90 rounded-top" src="{{asset("data/images/shorttrip/moe-yun-gyi-resort-22.jfif")}}" alt="#" />
                            <h3>Accommodation</h3>
                            <span>
                            Boat House : 1 Double bed ( 2 people)</br>
                            Triple Room  : 2 Single beds (3 people)<br/>
                            Family Room :  3 Single beds (6 people)<br/>
                            Twin Room Lake View : 1 Double bed ( 2 people)</br>
                            Deluxe Twin Room : 2 Single beds (2 people)

                            </span>
                        </div>
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/moe-yun-gyi-resort-16.jfif")}}" alt="#" />
                            <h3>Dining</h3>
                            <span>
                               The resort features a restaurant that serves local and traditional Burmese cuisine, often with fresh ingredients sourced from nearby areas.
                            </span>
                        </div>
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/moe-yun-gyi-resort-19.jfif")}}" alt="#" />
                        ...
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/ShweP4.jfif")}}" alt="#" />
                            <h3>Location and Accessibility</h3>
                            <span>
                            Address : No.99-C, Yangon-Bago Highway, 10 Miles<br/>
                            Contact : 09457400006<br/>
                            Shwe Pyi Resort is conveniently located close to Bago City, making it easily accessible by car. It’s also a short drive from Yangon, making it a popular destination for both locals and tourists. 

                            </span>

                        </div>
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/ShweP3.jfif")}}" alt="#" />
                            <h3>Accommodation</h3>
                            <span>
                            Shwe Pyi Resort offers a variety of accommodation options, including well-appointed rooms and private bungalows. These are designed with a blend of traditional Burmese architecture and modern comforts.

                            </span>
                        </div>
                        <div class="item">
                            <img class="img-fluid w-100 h-80 rounded-top" src="{{asset("data/images/shorttrip/ShweP9.jfif")}}" alt="#" />
                            <h3>Amenities and Activities</h3>
                            <span>
                            Swimming Pool<br>
                            Spa and Wellness<br>
                            Dining<br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>Reviews</h2>
                    <span>Some good reviews describe about places, local food, and a famous pagoda in Bago City.offers a perfect blend of cultural heritage and natural beauty, with its stunning pagodas, vibrant markets, and serene landscapes, making it a must-visit destination for travelers seeking an authentic Myanmar experience.</span>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card" style="width: 90%; height:fit-content;">
                    <img src="{{asset("images/".$b->img)}}" class="img-fluid w-100 h-80 rounded-top" alt="...">
                    <div class="card-body">
...
{{--                    </figure>--}}
{{--                    <div class="travel">--}}
{{--                        <span>Post  By : Bago Tourism  Industry</span>--}}
